...
//
//     final problems = problemsFromJson(jsonString);

import 'dart:convert';

Problems problemsFromJson(String str) => Problems.fromJson(json.decode(str));

String problemsToJson(Problems data) => json.encode(data.toJson());
